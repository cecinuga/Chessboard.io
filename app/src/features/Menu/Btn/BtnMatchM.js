...
export default function BtnMatchM({ name, img, classes, current }) {
    ...
    return (
        <div className={"Btn BtnMatchM inline-block mr-2 mt-2 bg-orange-300 hover:bg-orange-400 p-1 text-orange-800 hover:text-orange-700 rounded border-2 border-solid border-orange-800 mb-2 font-semibold "+classes}>
